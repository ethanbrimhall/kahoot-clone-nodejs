...
socket.on('questionOver', function (playerData, correct) {
    ...
    var answer1percent = answer1 / total * 100;
    var answer2percent = answer2 / total * 100;
    var answer3percent = answer3 / total * 100;
    var answer4percent = answer4 / total * 100;
    ...
    document.getElementById('square1').style.height = answer1percent + "px";
    document.getElementById('square2').style.height = answer2percent + "px";
    document.getElementById('square3').style.height = answer3percent + "px";
    document.getElementById('square4').style.height = answer4percent + "px";
